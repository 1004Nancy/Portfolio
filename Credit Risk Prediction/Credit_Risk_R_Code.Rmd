...
```{r}
loan <- read_csv("/Users/nancyli/Desktop/BAN 6053 - Intro To ML/Final Loan Default/loan_train.csv") %>%
  clean_names()
...
```{r}
loan_kaggle <- read_csv("/Users/nancyli/Desktop/BAN 6053 - Intro To ML/Final Loan Default/loan_holdout.csv") 
loan_kaggle %>% skim()
...
scored_kaggle %>%
  write_csv("my_kaggle_submission_loan.csv")
```
